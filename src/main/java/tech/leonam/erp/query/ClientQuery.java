...
public class ClientQuery {
    public static final String SELECT_BY_ID = "select * from clientes where id = ?";
    ...
    public static final String DELETE_BY_ID = "delete from clientes where id = ?";
    public static final String EXISTS_ID = "select 1 from clientes where cpf_or_cnpj = ? limit 1";

...
public class TipoPagamentoControllerTest {
        ...
        public void deveBuscarTodosTiposPagamento() throws Exception {
                ...
                Mockito.when(tipoPagamentoService.buscarTodosTiposPagamento(Mockito.anyInt(), Mockito.anyInt(),
        ...
        public void deveAtualizarTipoPagamento() throws Exception {
                ...
                Mockito.when(tipoPagamentoService.atualizarTipoPagamento(Mockito.eq(id),
                                Mockito.any(TipoPagamentoDTO.class)))
